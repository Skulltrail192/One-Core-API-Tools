...
if exist "%~dp0BootWIM\sources" (
	...
	XCOPY Sources\DVD\sources\w32uiimg.dll "%~dp0BootWIM\sources" /Y /F
	
	XCOPY Sources\DVD\sources\spwizimg.dll "%~dp0BootWIM\sources" /Y /F	
	
	XCOPY Sources\DVD\sources\setup.exe "%~dp0BootWIM\sources" /Y /F
	)
)