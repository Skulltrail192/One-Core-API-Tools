...
IF %a%==1 (
	...
	REM %~dp0tools\dism\ImageX /mountrw "Sources\sources\boot.wim" 2 %~dp0BootWIM
	
	FOR /F "tokens=*" %%g IN ('tools\bincheck\bincheck.exe Sources\sources\winsetup.dll') do (SET binarch=%%g)
	...
	if "%binarch%" == "32" (	
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xEC\x44\x33\xC0\x56\x33\xF6/:8" -e "s/\x83\xEC\x44\x33\xC0\x56\x33\xF6/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\sources\winsetup.dll" -o "Sources\sources\winsetup1.dll"

		del "Sources\sources\winsetup.dll"

		ren "Sources\sources\winsetup1.dll" winsetup.dll

		REM Patch WinSetup.dll on mounted image to allow install Windows XP/2003  - Try Win8 32 bits Setup
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x4C\x53\x33\xDB\x83\x3D/:11" -e "s/\x83\xE4\xF8\x83\xEC\x4C\x53\x33\xDB\x83\x3D/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\sources\winsetup.dll" -o "Sources\sources\winsetup1.dll"

		del "Sources\sources\winsetup.dll"

		ren "Sources\sources\winsetup1.dll" winsetup.dll

		REM REM Patch WinSetup.dll on mounted image to allow install Windows XP/2003  - Try Win8.1 32 bits Setup
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x44\x53\x33\xDB\x83\x3D/:11" -e "s/\x83\xE4\xF8\x83\xEC\x44\x53\x33\xDB\x83\x3D/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\sources\winsetup.dll" -o "Sources\sources\winsetup1.dll"
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x3C\x53\x56\x57\x33\xFF\x83/:12" -e "s/\x83\xE4\xF8\x83\xEC\x3C\x53\x56\x57\x33\xFF\x83/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\sources\winsetup.dll" -o "Sources\sources\winsetup1.dll"
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x44\x53\x56\x57\x33\xFF\x83/:12" -e "s/\x83\xE4\xF8\x83\xEC\x44\x53\x56\x57\x33\xFF\x83/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\sources\winsetup.dll" -o "Sources\sources\winsetup1.dll"
	...
	XCOPY Sources\sources\winsetup.dll "%~dp0BootWIM\sources" /Y /F
)