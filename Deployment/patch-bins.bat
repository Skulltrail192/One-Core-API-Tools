...
IF %a%==1 (
	...
	if "%binARCH%" == "32" (	
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x4C\x53\x33\xDB\x83\x3D/:11" -e "s/\x83\xE4\xF8\x83\xEC\x4C\x53\x33\xDB\x83\x3D/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\DVD\sources\winsetup.dll" -o "Sources\DVD\sources\winsetup1.dll"
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x44\x53\x33\xDB\x83\x3D/:11" -e "s/\x83\xE4\xF8\x83\xEC\x44\x53\x33\xDB\x83\x3D/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\DVD\sources\winsetup.dll" -o "Sources\DVD\sources\winsetup1.dll"
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x3C\x53\x56\x57\x33\xFF\x83/:12" -e "s/\x83\xE4\xF8\x83\xEC\x3C\x53\x56\x57\x33\xFF\x83/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\DVD\sources\winsetup.dll" -o "Sources\DVD\sources\winsetup1.dll"
		...
		"%~dp0tools\bbe\%ARCH%\bbe.exe" -b "/\x83\xE4\xF8\x83\xEC\x44\x53\x56\x57\x33\xFF\x83/:12" -e "s/\x83\xE4\xF8\x83\xEC\x44\x53\x56\x57\x33\xFF\x83/\x33\xF6\x8B\xC6\xC9\xC2\x08\x00/"" "Sources\DVD\sources\winsetup.dll" -o "Sources\DVD\sources\winsetup1.dll"
